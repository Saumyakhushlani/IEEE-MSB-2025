...
const images = [
  ...
  { src: aboutWrapper_2, alt: 'Tropical beach paradise' },
  { src: aboutWrapper_3, alt: 'Enchanted forest' }
];
...
export const ImageCarousel = () => {
  ...
  return (
    <div className="relative w-full h-[200px] sm:h-[300px] lg:h-[400px] overflow-hidden rounded-2xl shadow-2xl bg-muted">
