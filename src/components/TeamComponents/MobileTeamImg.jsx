...
const MobileTeamImg = ({img,name,post}) => {
  ...
  return (
    <div className='flex flex-col gap-5 hover:shadow-blue-500 mx-4'>
      <img className={`w-24 h-24 sm:w-55 sm:h-55 rounded-full hover:scale-95 hover:opacity-60 hover:border-2 hover:border-blue-500 hover:bg- duration-500`} src={`${img}`} alt="" />
