  ...
  const pastSpeakers = [
     {
      id: 1,
      name: 'Mr Raghav Garg',
      designation: 'Software Engineer / Speaker',
      src: 'https://d3a6pe8ygpgu8u.cloudfront.net/5eb393ee95fab7468a79d189/images/dc0906f5-2811-4892-a46e-512710b7968f.png'
    },
    { id: 2, name: 'Mr Raj Vikramaditya', designation: 'Founder, takeUforward', src: '/Striver.jpg' },
    { id: 3, name: 'Mr Sanjeev Somasundaram', designation: 'Director, Talent Acquisition at Google', src: '/Sanjeev Somasundaram.jpeg' },
    { id: 4, name: 'Ms.Neha Agrawal', designation: 'Founder of Mathematically Inclined', src: '/Neha Agrawal.jpg' },
    { id: 5, name: 'Ms.Preeti Saran', designation: 'Indian Foreign Service cadre', src: '/Preeti Saran.jpg' },
    { id: 6, name: 'Ms.Jagrati Awasthi', designation: 'AIR-2 UPSC CSE 2020', src: '/Jagrati Awasthi.jpg' },
    { id: 7, name: 'Rania Lampou', designation: 'STEM instructor at The Greek Astronomy', src: '/Rania Lampou.jpg' },
    { id: 8, name: 'Bhakti Sharma', designation: 'Sarpanch and Motivational Speaker', src: '/Bhakti Sharma.jpg' },
    { id: 9, name: 'Suneha Gadpande', designation: 'Master mariner', src: '/Suneha Gadpande.jpg' },
    { id: 10, name: 'Prof. Anandi Giridharan', designation: 'Principal Research Scientist', src: '/Anandi Giridharan.jpg' },
  ]
