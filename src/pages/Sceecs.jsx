...
const Sceecs = () => {
  ...
  const pastSpeakers = [
    { id: 1, name: 'Jayan Gupta', designation: 'Member of Technical Staff,Ai Ml Engineer | GFG', src: '/gfg-speaker.png' },
    { id: 2, name: 'Kamran Ali', designation: 'Sr. Engineering Manager | Atlassian', src: '/kamran_ali.jpeg' },
    { id: 3, name: 'Sunchit Dudeja', designation: 'SDE | Adobe', src: '/sanchit_dudeja.jpeg' },
    { id: 4, name: 'Love Babbar', designation: 'Founder of Codehelp', src: '/love_babbar.jpg' },
    { id: 5, name: 'Lakshya Kumar', designation: 'Instructor at Codehelp', src: '/lakshya_kumar.jpeg' },
    { id: 6, name: 'Kshitij Kumar', designation: 'Chief Data Officer at OneFootball', src: '/kshitiz_kumar.png' },
    { id: 7, name: 'Sandeep Jain', designation: 'Founder and CEO - Geeksforgeeks', src: '/Sandeep_jain.jpg' },
    { id: 8, name: 'Pushyamitra Bhargav', designation: 'Additional Advocate General, Indore Bench (MP Govt)', src: '/pushyamitra.jpg' },
    { id: 9, name: 'Subhash Khare', designation: 'Vice President of Wipro', src: 'Subhash_khare.jpg' },
    { id: 10, name: 'Sunil K. Prasad', designation: 'Chief Technology Officer at Leidos', src: '/Sunil_prasad.jpg' },
    { id: 11, name: 'Tomy Sebastian', designation: 'Director, Motor Drive Systems at Halla Mechatronics', src: '/tomy.jpg' },
    { id: 12, name: 'Abhas Mitra', designation: 'Astrophysicist', src: '/Abhas_mitra.jpg' },
    { id: 13, name: 'Anima Patil-Sabale', designation: 'Scientist-Astronaut', src: '/Anima_patil.jpg' },
